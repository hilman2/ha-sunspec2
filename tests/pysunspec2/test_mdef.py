...
def test_validate_find_point():
    with open('./custom_components/sunspec2/pysunspec2/models/json/model_702.json') as f:
...
def test_validate_attrs():
    with open('./custom_components/sunspec2/pysunspec2/models/json/model_701.json') as f:
        model_json = json.load(f)
...
def test_validate_group_point_dup():
    with open('./custom_components/sunspec2/pysunspec2/models/json/model_704.json') as f:
        model_json = json.load(f)
...
def test_from_json_str():
    with open('./custom_components/sunspec2/pysunspec2/models/json/model_63001.json') as f:
        model_json = json.load(f)
